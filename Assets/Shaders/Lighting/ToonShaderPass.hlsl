    ...
    */
    ...
    Varyings Vertex(Attributes IN)
    {
        ...
        OUT.tangentWS = normalize(mul(IN.tangent, unity_ObjectToWorld));
    ...
    */
    ...
    float3 Fragment(Varyings IN) : SV_Target
    {
        ...
        //float3 bumpNormal = normalize((normalMap.x * IN.tangentWS) + (normalMap.y * IN.binormalWS) + (normalMap.z * IN.normalWS));
        //float NoL = dot(bumpNormal, light.direction);
